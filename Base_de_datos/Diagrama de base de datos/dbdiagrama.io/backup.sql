...
--
-- Name: COLUMN configurations.language; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN configurations.timezone; Type: COMMENT; Schema: public; Owner: postgres
--
...
COMMENT ON COLUMN public.direcction.type IS '0=送货地址（可以有多个，如果没有则默认用商店地址， 1=发票地址，2=商店地址（批发商和零售商）';
...
--
-- Name: COLUMN users.cif; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: user_sessions unique_device_finger_user; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.user_sessions
    ADD CONSTRAINT user_sessions_pkey PRIMARY KEY (token_id);
...
--
-- Name: configurations Enable users to view their own data only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only" ON public.configurations TO authenticated, anon USING ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "Enable users to view their own data only" ON public.users TO authenticated, anon USING ((( SELECT auth.uid() AS uid) = id));


--
-- Name: cart_details Enable users to view their own data only Backend; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only Backend" ON public.cart_details TO authenticated, anon USING (((current_setting('request.user_id'::text, true))::uuid = ( SELECT carts.user_id
   FROM public.carts
  WHERE (carts.id = cart_details.cart_id))));


--
-- Name: carts Enable users to view their own data only Backend; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only Backend" ON public.carts TO authenticated, anon USING (((current_setting('request.user_id'::text, true))::uuid = user_id));


--
-- Name: configurations Enable users to view their own data only Backend; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only Backend" ON public.configurations TO authenticated, anon USING (((current_setting('request.user_id'::text, true))::uuid = user_id));


--
-- Name: deliveries Enable users to view their own data only Backend; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only Backend" ON public.deliveries TO authenticated, anon USING (((current_setting('request.user_id'::text, true))::uuid = delivery_person));


--
-- Name: delivery_timeline Enable users to view their own data only Backend; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only Backend" ON public.delivery_timeline TO authenticated, anon USING (((current_setting('request.user_id'::text, true))::uuid = ( SELECT deliveries.delivery_person
   FROM public.deliveries
  WHERE (deliveries.id = delivery_timeline.delivery_id))));


--
-- Name: direcction Enable users to view their own data only Backend; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only Backend" ON public.direcction TO authenticated, anon USING (((current_setting('request.user_id'::text, true))::uuid = user_id));


--
-- Name: messages Enable users to view their own data only Backend; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only Backend" ON public.messages TO authenticated, anon USING ((EXISTS ( SELECT 1
   FROM public.chat_participants
  WHERE ((chat_participants.chat_panel_id = messages.chat_panel_id) AND (chat_participants.user_id = (current_setting('request.user_id'::text, true))::uuid)))));


--
-- Name: notifications Enable users to view their own data only Backend; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only Backend" ON public.notifications TO authenticated, anon USING ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: users Enable users to view their own data only Backend; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable users to view their own data only Backend" ON public.users TO authenticated USING (((current_setting('request.user_id'::text, true))::uuid = id));
...
--
-- Name: configurations; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE configurations_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.configurations_id_seq TO anon;
GRANT ALL ON SEQUENCE public.configurations_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.configurations_id_seq TO service_role;
