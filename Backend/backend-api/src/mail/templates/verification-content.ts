import { DateFormatService } from '../../common/formatter/date-format.service';
...
export const VerificationContent = (
  ...
  timezone: string,
  registerDate: Date,
): VerificationContentTranslation => {
  const lockDate = dateFormatService.addDays(registerDate, 3);
  const deleteDat = dateFormatService.addDays(lockDate, 7);

  const formattedLockDate = dateFormatService.formatDate(
    lockDate,
    lang,
    timezone,
  );
  const formattedDeleteDate = dateFormatService.formatDate(
    deleteDat,
    lang,
    timezone,
  );
  ...
  const translations: Record<SupportedLang, VerificationContentTranslation> = {
    'zh-CH': {
      ...
      reminderVerification:
        '目前您的邮箱尚未完成验证，因此部分功能将受到限制。为了实现正常的功能并保障您的账户安全，请点击下方的“验证按钮”完成邮箱验证。',
    ...
    'zh-HK': {
      ...
      reminderVerification:
        '目前您的郵箱尚未完成驗證，因此部分功能將受到限制。為了實現正常的功能並保障您的帳戶安全，請點擊下方的“驗證按鈕”完成郵箱驗證。',
    ...
    en: {
      ...
      reminderVerification:
        'Currently, your email has not been verified, so some functions will be restricted. To achieve normal functionality and ensure the security of your account, please click the "Verify" button below to complete the email verification.',
      ...
      repeatReminder:
        'To achieve normal functionality, please click the verification button to verify!',
      buttonText: 'Verify',
      support:
    ...
    'es-ES': {
      ...
      reminderVerification:
        'Actualmente, su correo electrónico no ha sido verificado, por lo que algunas funciones estarán restringidas. Para lograr una funcionalidad normal y garantizar la seguridad de su cuenta, haga clic en el botón "Verificar" a continuación para completar la verificación del correo electrónico.',
      ...
      repeatReminder:
        'Para lograr una funcionalidad normal, ¡haga clic en el botón de verificación para verificar!',
      buttonText: 'Verificar',
      support:
        'Si tiene alguna pregunta, no dude en ponerse en contacto con nuestro equipo de atención al cliente.',
      notReply:
        'Este correo electrónico es enviado automáticamente por el sistema, por favor no responda.',
    },
    'ca-ES-valencia': {
      ...
      reminderVerification:
        'Actualment, el vostre correu electrònic no ha estat verificat, per la qual cosa algunes funcions estaran restringides. Per aconseguir una funcionalitat normal i garantir la seguretat del vostre compte, feu clic al botó "Verificar" a continuació per completar la verificació del correu electrònic.',
      ...
      repeatReminder:
        'Per aconseguir una funcionalitat normal, feu clic al botó de verificació per verificar!',
      buttonText: 'Verificar',
      support:
        'Si teniu alguna pregunta, no dubteu a posar-vos en contacte amb el nostre equip d’atenció al client.',
      notReply:
        'Aquest correu electrònic és enviat automàticament pel sistema, si us plau, no respongueu.',
    },
    'fr-FR': {
      ...
      reminderVerification:
        'Actuellement, votre adresse e-mail n’a pas été vérifiée, certaines fonctions seront donc restreintes. Pour assurer le bon fonctionnement et la sécurité de votre compte, veuillez cliquer sur le bouton "Vérifier" ci-dessous pour compléter la vérification de votre adresse e-mail.',
      ...
      repeatReminder:
        'Pour assurer le bon fonctionnement, veuillez cliquer sur le bouton de vérification pour vérifier !',
      buttonText: 'Vérifier',
      support:
        'Si vous avez des questions, n’hésitez pas à contacter notre équipe du service client.',
      notReply:
        'Cet e-mail est envoyé automatiquement par le système, veuillez ne pas répondre.',
    },
    'it-IT': {
      ...
      reminderVerification:
        'Attualmente, il tuo indirizzo email non è stato verificato, quindi alcune funzionalità saranno limitate. Per garantire il corretto funzionamento e la sicurezza del tuo account, clicca sul pulsante "Verifica" qui sotto per completare la verifica dell’email.',
      ...
      repeatReminder:
        'Per garantire il corretto funzionamento, clicca sul pulsante di verifica per verificare!',
      buttonText: 'Verifica',
      support:
        'Se hai domande, non esitare a contattare il nostro team di assistenza clienti.',
      notReply:
        'Questa email è inviata automaticamente dal sistema, per favore non rispondere.',
    },
    'ru-RU': {
      ...
      reminderVerification:
        'В настоящее время ваш адрес электронной почты не подтвержден, поэтому некоторые функции будут ограничены. Чтобы обеспечить нормальную работу и безопасность вашей учетной записи, пожалуйста, нажмите кнопку "Подтвердить" ниже для завершения подтверждения электронной почты.',
      ...
      repeatReminder:
        'Чтобы обеспечить нормальную работу, пожалуйста, нажмите кнопку подтверждения для верификации!',
      buttonText: 'Подтвердить',
      support:
        'Если у вас есть вопросы, пожалуйста, свяжитесь с нашей службой поддержки.',
      notReply:
        'Это письмо отправлено автоматически системой, пожалуйста, не отвечайте на него.',
    },
    'ro-RO': {
      ...
      reminderVerification:
        'În prezent, adresa dvs. de e-mail nu a fost verificată, așa că anumite funcționalități vor fi restricționate. Pentru a beneficia de toate funcțiile și pentru a vă proteja contul, vă rugăm să faceți clic pe butonul "Verificare" de mai jos pentru a finaliza verificarea adresei de e-mail.',
      ...
      repeatReminder:
        'Pentru a beneficia de funcționalitățile complete, faceți clic pe butonul de verificare!',
      buttonText: 'Verificare',
      support:
        'Dacă aveți întrebări, nu ezitați să contactați echipa noastră de asistență pentru clienți.',
      notReply:
        'Acest e-mail a fost trimis automat de sistem, vă rugăm să nu răspundeți.',
    },
    'pt-PT': {
      ...
      reminderVerification:
        'Atualmente, o seu endereço de e-mail ainda não foi verificado, pelo que algumas funcionalidades estarão limitadas. Para garantir o funcionamento normal e a segurança da sua conta, por favor clique no botão "Verificar" abaixo para completar a verificação do e-mail.',
      ...
      repeatReminder:
        'Para garantir o funcionamento normal, clique no botão de verificação para verificar!',
      buttonText: 'Verificar',
      support:
        'Se tiver alguma dúvida, não hesite em contactar a nossa equipa de apoio ao cliente.',
      notReply:
        'Este e-mail foi enviado automaticamente pelo sistema, por favor não responda.',
    },
  };
