import { pgTable, foreignKey, serial, smallint, varchar, unique, char, check, bigint, timestamp, numeric, integer, jsonb, uuid, index, text, boolean, uniqueIndex, date, doublePrecision, primaryKey, pgSequence, pgEnum } from "drizzle-orm/pg-core"
...
export const variant_products = pgTable("variant_products", {
	...
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "variant_products_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
...
export const files = pgTable("files", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "files_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
...
export const cart_details = pgTable("cart_details", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "cart_details_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const chat_panels = pgTable("chat_panels", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "chat_panel_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	name: varchar({ length: 50 }).notNull(),
	created_at: timestamp({ mode: 'string' }).default(sql`(now() AT TIME ZONE 'utc'::text)`).notNull(),
});
...
export const discounts = pgTable("discounts", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "discounts_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
...
export const message_files = pgTable("message_files", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "message_files_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const products_files = pgTable("products_files", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "products_files_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	product_id: bigint({ mode: "bigint" }).notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	file_id: bigint({ mode: "bigint" }).notNull(),
...
export const carts = pgTable("carts", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "cart_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	user_id: uuid().notNull(),
	created_at: timestamp({ mode: 'string' }).default(sql`(now() AT TIME ZONE 'utc'::text)`).notNull(),
}, (table) => [
	foreignKey({
...
export const deliveries = pgTable("deliveries", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "deliveries_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const products = pgTable("products", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "products_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	user_id: uuid().notNull(),
	name: varchar({ length: 50 }).notNull(),
...
export const directions = pgTable("directions", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "directions_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	user_id: uuid().notNull(),
...
export const delivery_timeline = pgTable("delivery_timeline", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "delivery_timeline_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const order_details = pgTable("order_details", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "order_details_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	order_id: bigint({ mode: "bigint" }).notNull(),
	product_code: varchar({ length: 50 }).notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const messages = pgTable("messages", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "messages_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const notifications = pgTable("notifications", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "notifications_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	user_id: uuid().notNull(),
...
export const orders = pgTable("orders", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "bigint" }).primaryKey().generatedByDefaultAsIdentity({ name: "orders_id_seq", startWith: 1, increment: 1, minValue: 1, cache: 1 }),
	retailer_id: uuid(),
	wholesaler_id: uuid(),
	status: smallint().default(sql`'1'`).notNull(),
