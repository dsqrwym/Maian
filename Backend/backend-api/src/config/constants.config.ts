...
export const ENV = {
  ...
  PRODUCT_MAX_SUB_CATEGORIES: 'PRODUCT_MAX_SUB_CATEGORIES',
  CART_MAX_WHOLESALERS_PER_RETAILER: 'CART_MAX_WHOLESALERS_PER_RETAILER',
  CART_MAX_LINES_PER_CART: 'CART_MAX_LINES_PER_CART',
  ORDER_MAX_LINES: 'ORDER_MAX_LINES',
  ...
  // Video Play Token
  // 视频播放临时令牌配置
  VIDEO_PLAY_TOKEN_TTL: 'VIDEO_PLAY_TOKEN_TTL',
  VIDEO_PLAY_TOKEN_SECRET: 'VIDEO_PLAY_TOKEN_SECRET',
