...
import { countries, provinces, currencies, cities, users, categories, variant_products, products, discounts, files, message_files, messages, products_files, configurations, deliveries, directions, delivery_timeline, chat_panels, notifications, user_sessions, verification_tokens, carts, cart_details, orders, order_details, wholesaler_staffs, user_uploads, chat_participants, product_categories, document_sequences, order_pdf_files, category_translations, product_translations } from "./schema";
...
export const variant_productsRelations = relations(variant_products, ({one, many}) => ({
	user_created_by: one(users, {
...
export const delivery_timelineRelations = relations(delivery_timeline, ({one}) => ({
...
export const wholesaler_staffsRelations = relations(wholesaler_staffs, ({one}) => ({
	user_created_by: one(users, {
...
export const chat_participantsRelations = relations(chat_participants, ({one}) => ({
	chat_panel: one(chat_panels, {
...
export const document_sequencesRelations = relations(document_sequences, ({one}) => ({
	user: one(users, {
...
export const order_pdf_filesRelations = relations(order_pdf_files, ({one}) => ({
	file: one(files, {
...
export const category_translationsRelations = relations(category_translations, ({one}) => ({
	user: one(users, {
...
export const product_translationsRelations = relations(product_translations, ({one}) => ({
	product: one(products, {
